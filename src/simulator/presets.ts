...
export const rulesetPresets = {
  ...
  // Can't be named "constructor" due to conflict with the keyword
  constructorRules: {
    name: "Constructor",
    initialState: "0",
    states: {
